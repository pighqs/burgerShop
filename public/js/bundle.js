    ...
    _createClass(Navbar, [{
        ...
        value: function render() {
            return React.createElement(
                'nav',
                { className: 'navbar navbar-burger navbar-expand-lg navbar-dark bg-dark' },
                React.createElement(
                    'button',
...
// ROUTER
var Router = __webpack_require__(12).BrowserRouter;
var Route = __webpack_require__(12).Route;

// Components importés
var Navbar = __webpack_require__(22);
var HomeTitle = __webpack_require__(76);
var About = __webpack_require__(77);
var Shop = __webpack_require__(78);
...
var HomeTitle = function (_React$Component) {
   ...
   function HomeTitle() {
      ...
      return _possibleConstructorReturn(this, (HomeTitle.__proto__ || Object.getPrototypeOf(HomeTitle)).call(this));
   }
    ...
    _createClass(About, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'section',
                    { className: 'home-infos row' },
                    React.createElement(
                        'div',
                        { className: 'col-sm-4' },
                        React.createElement('i', { className: 'fa fa-cutlery fa-4x', 'aria-hidden': 'true' }),
                        React.createElement(
                            'h2',
                            null,
                            'Produits Bios'
                        ...
                        React.createElement(
                            'p',
                            null,
                            'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi at, illo quae earum deleniti eveniet commodi magnam. Iusto voluptas totam vitae, dignissimos eligendi ipsa, perferendis qui quas dolore, laudantium veritatis voluptatum, maiores sint repudiandae doloribus.'
                        )
                    ),
                    React.createElement(
                        'div',
                        { className: 'col-sm-4' },
                        React.createElement('i', { className: 'fa fa-clock-o fa-4x', 'aria-hidden': 'true' }),
                        React.createElement(
                            'h2',
                            null,
                        ...
                        React.createElement(
                            'p',
                            null,
                            'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium deleniti optio nisi sed, at, dolor qui excepturi exercitationem error delectus earum provident aut numquam, vero necessitatibus iure tempora accusantium rerum ad impedit? Voluptate, dignissimos, id.'
                        )
                    ),
                    React.createElement(
                        'div',
                        { className: 'col-sm-4' },
                        React.createElement('i', { className: 'fa fa-bicycle fa-4x', 'aria-hidden': 'true' }),
                        React.createElement(
                            'h2',
                            null,
                            'Livraison Offerte'
                        ...
                        React.createElement(
                            'p',
                            null,
                            'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita molestiae cum neque iusto a esse rem suscipit quaerat deleniti tenetur culpa facilis provident id, alias veritatis, nostrum rerum fugit consequatur magni laudantium. Dolor alias, porro.'
                        )
                    )
                )
            );
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'div',
                { className: 'card offset-1 col-10 offset-sm-1 col-sm-4' },
                React.createElement('img', { className: 'card-img-top', src: 'https://lacapsule.academy/wks2/burger_1.png' }),
                React.createElement(
                  'div',
                  { className: 'card-body' },
                  React.createElement(
              ...
              React.createElement(
                'div',
                { className: 'card offset-1 col-10 offset-sm-1 col-sm-4' },
                React.createElement('img', { className: 'card-img-top', src: 'https://lacapsule.academy/wks2/burger_2.png' }),
                React.createElement(
                  'div',
                  { className: 'card-body' },
                  React.createElement(
              ...
              React.createElement(
                'div',
                { className: 'card offset-1 col-10 offset-sm-1 col-sm-4' },
                React.createElement('img', { className: 'card-img-top', src: 'https://lacapsule.academy/wks2/burger_3.png' }),
                React.createElement(
                  'div',
                  { className: 'card-body' },
                  React.createElement(
